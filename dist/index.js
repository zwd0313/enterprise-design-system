    ...
    return (React.createElement("header", { style: { position: 'sticky', top: 0, zIndex: 40, height: 40, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 18px', background: T.topbarBg, backdropFilter: 'blur(18px)', borderBottom: `1px solid ${T.borderSubtle}`, flexShrink: 0 } },
        ...
        React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: 7, position: 'relative' } },
            ...
            React.createElement("div", { style: { position: 'relative' } },
                React.createElement("button", { onClick: () => setShowUserMenu(!showUserMenu), style: { display: 'flex', alignItems: 'center', gap: 6, padding: '2px 6px 2px 2px', borderRadius: 8, border: 'none', background: 'rgba(255,255,255,0.04)', color: T.textPrimary, fontSize: 13, cursor: 'pointer', transition: 'background 0.15s' } },
                ...
                showUserMenu && (React.createElement(React.Fragment, null,
                    ...
                    React.createElement("div", { style: { position: 'absolute', top: 40, right: 0, zIndex: 41, width: 200, borderRadius: 10, background: T.bgElevated, border: `1px solid ${T.borderSubtle}`, boxShadow: '0 8px 24px rgba(0,0,0,0.24)', overflow: 'hidden' } },
                        React.createElement("nav", { style: { padding: '6px 6px' } },
                            React.createElement(Link, { to: "/profile", onClick: () => setShowUserMenu(false), style: { display: 'flex', alignItems: 'center', gap: 9, width: '100%', padding: '8px 10px', borderRadius: 7, color: T.textSecondary, fontSize: 14, fontWeight: 450, cursor: 'pointer', textDecoration: 'none', marginBottom: 2 } },
                                React.createElement(Icon, { name: "user", size: 13 }),
                                React.createElement("span", null, "\u4E2A\u4EBA\u4E2D\u5FC3")),
                            React.createElement("button", { onClick: () => { setShowUserMenu(false); onLogout(); }, style: { display: 'flex', alignItems: 'center', gap: 9, width: '100%', padding: '8px 10px', borderRadius: 7, border: 'none', background: 'transparent', color: T.danger, fontSize: 14, fontWeight: 450, cursor: 'pointer', textAlign: 'left' } },
