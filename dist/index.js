        ...
        React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: 7, position: 'relative' } },
            ...
            React.createElement("div", { style: { position: 'relative' } },
                React.createElement("button", { onClick: () => setShowUserMenu(!showUserMenu), style: { display: 'flex', alignItems: 'center', gap: 7, padding: '3px 8px 3px 4px', borderRadius: 999, border: `1px solid ${T.borderSubtle}`, background: 'transparent', color: T.textPrimary, fontSize: 13, cursor: 'pointer' } },
                    React.createElement("span", { style: { width: 26, height: 26, borderRadius: '50%', background: T.accent + '20', border: `1px solid ${T.accent}40`, display: 'grid', placeItems: 'center', fontSize: 11, fontWeight: 700, color: T.accent, fontFamily: 'var(--eb-font-sans, "Inter", sans-serif)', letterSpacing: '0.02em' } }, userInitial),
                ...
                showUserMenu && (React.createElement(React.Fragment, null,
                    ...
                    React.createElement("div", { style: { position: 'absolute', top: 40, right: 0, zIndex: 41, width: 200, borderRadius: 10, background: T.bgElevated, border: `1px solid ${T.borderSubtle}`, boxShadow: '0 8px 24px rgba(0,0,0,0.24)', overflow: 'hidden' } },
                        React.createElement("nav", { style: { padding: '6px 6px' } },
                            React.createElement(Link, { to: "/profile", onClick: () => setShowUserMenu(false), style: { display: 'flex', alignItems: 'center', gap: 9, width: '100%', padding: '8px 10px', borderRadius: 7, color: T.textSecondary, fontSize: 13.5, fontWeight: 450, cursor: 'pointer', textDecoration: 'none', marginBottom: 2 } },
                                React.createElement(Icon, { name: "user", size: 13 }),
                                React.createElement("span", null, "\u4E2A\u4EBA\u4E2D\u5FC3")),
                            React.createElement("button", { onClick: () => { setShowUserMenu(false); onLogout(); }, style: { display: 'flex', alignItems: 'center', gap: 9, width: '100%', padding: '8px 10px', borderRadius: 7, border: 'none', background: 'transparent', color: T.danger, fontSize: 13.5, fontWeight: 450, cursor: 'pointer', textAlign: 'left' } },
